...
model_history = model.fit(photos_train, labels_train, batch_size=64, epochs=50, steps_per_epoch=30, verbose=1, 
                          validation_data=(photos_test, labels_test), shuffle=1)
...
model.save("/content/drive/MyDrive/A.I/CNN_plant.h5")
